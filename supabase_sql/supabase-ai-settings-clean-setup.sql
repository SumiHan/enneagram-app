...
VALUES (
  '기본 에니어그램 분석 프롬프트 (8항목)',
  '사용자의 설문 응답을 바탕으로 에니어그램 유형을 분석하고 8개 항목의 상세한 리포트를 작성',
...

{
  ...
  "wing": "날개 유형 (예: 3w2, 9w1 - 인접 유형의 영향 방향)",
  "characteristics": "이 유형의 주요 성격 특징 요약 (회피 욕구, 사고/감정 패턴, 강점 등을 포함하여 3-5문장으로 설명)",
  "integration_disintegration": "성장(통합) 및 퇴화(분열) 방향 (건강할 때와 불건강할 때의 변화 양상을 2-3문장으로 설명)",
  "famous_examples": ["대표적인 전 세계 유명인 1", "대표적인 전 세계 유명인 2", "대표적인 전 세계 유명인 3"],
  "major_based_career_path": "전공 기반 진로 로드맵 (사전 설문의 전공 선택과 에니어그램 성향을 통합한 진로 전략을 4-5문장으로 구체적으로 작성)",
  "career_guidance": "일반적인 직업 및 전공 방향 조언 (유형별로 적합한 직업군, 진로 가치 중심 조언을 3-4문장으로 작성)",
  "growth_advice": "개인적 성장 및 자기관리 조언 (자기 인식, 감정 관리, 관계 개선 등 구체적 조언을 2-3문장으로 작성)"
}
